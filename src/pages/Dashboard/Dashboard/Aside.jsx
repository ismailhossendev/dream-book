            ...
            <ul className="menu p-4 w-72  text-base-content">
                <div>
                    ...
                    <ul className="mt-8 space-y-2 tracking-wide">
                        <li>
                            <NavLink to='/dashboard' aria-label="dashboard" className="relative flex items-center space-x-4 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
